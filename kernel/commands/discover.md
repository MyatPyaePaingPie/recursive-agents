---
description: Activate discovery mode - map repo, find tooling, extract conventions
---
...
Discovery mode focuses on populating the world model with reality, not assumptions.
